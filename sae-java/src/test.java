...
public class test {
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in); // Correction ici
                ...
                case "1":
                    ...
                    switch (choixGererUtilisateur) {
                        case "1":
                            ...
                            break;
                        case "2":
                            System.out.println("Méthode supprimer compte vendeur à ajouter");
                            break;
                        case "0":
                            // On ne sort que du sous-menu, pas du menu admin
                            break;
                        default:
                            System.out.println("Choix invalide.");
                    }
